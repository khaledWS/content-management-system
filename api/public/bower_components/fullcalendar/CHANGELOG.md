...
- day numbers in month view should be localized (#222d329)
...
- dayClick triggered when swiping on touch devices (#222d322)
...
Bugfixes:
- list view rendering event times incorrectly (#222d324)
